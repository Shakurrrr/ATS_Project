    ...
    def check_db_connection(self):
        try:
            ...
            if not self.db_online:
                ...
                lcd.clear()
                lcd.write_string("DB CONNECTED OK")
        ...
        try:
            ...
            for log in logs:
                ...
                if res:
                    eid = res[0]
                    self.pg_cursor.execute("""
                        INSERT INTO employee_attendance (employee_id, type, date, time, timestamp, synced)
